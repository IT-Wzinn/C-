...
nên nếu muốn xuất ra đúng theo đúng thứ tự truyền vào thì cần phải truyền vào vector trước rồi mới truyền vào set ( Nếu ptử chưa có trong set/map thì thêm vào vector trước rồi mới thêm vào set/map)
