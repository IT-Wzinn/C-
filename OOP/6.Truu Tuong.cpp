...
public: 
    virtual void Tratien(int sotien) = 0;      // Hàm thuần ảo (=0): Mục tiêu là thanh toán bằng hình thức gì thì cũng phải trả tiền 
};
...
_ Chọn Tratien là hàm thuần ảo vì mọi hình thức thanh toán bắt buộc phải có hành vi “trả tiền”, nhưng cách trả thì khác nhau
